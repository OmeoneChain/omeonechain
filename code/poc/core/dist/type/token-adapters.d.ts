 ...
 */
export declare function calculateTransactionFees(amount: number, transactionType: TokenActionType): TokenFees;
/**
 * Validate token transfer request
 * @param request Transfer request to validate
 * @returns Validation result
 */
export declare function validateTokenTransfer(request: TokenTransferRequest): {
    isValid: boolean;
    errors: string[];
};
