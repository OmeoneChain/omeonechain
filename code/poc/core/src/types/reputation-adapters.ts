...
export type TransactionData = 
  ...
  | GovernanceTransactionData
  | SocialActionTransactionData;
 ...
 */
export function formatTokenDataForChain(tokenData: any): TokenTransactionData {
  return {
    from: tokenData.from,
    to: tokenData.to,
 ...
 */
export function formatSocialActionForChain(actionData: any): SocialActionTransactionData {
  return {
 ...
 */
export function isTokenTransactionData(data: any): data is TokenTransactionData {
  return data && 
