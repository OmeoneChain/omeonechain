...
export const useGeolocation = (options: UseGeolocationOptions = {}) => {
  ...
  }, [state.supported, opts, reverseGeocode]);
  ...
  useEffect(() => {
    if (opts.requestPermission && state.supported) {
      getCurrentPosition();
    }
  }, [opts.requestPermission, state.supported, getCurrentPosition]);
  ...
  return {
    ...
    getCurrentPosition,
    requestPermission,
    clearLocation: () => setState(prev => ({ ...prev, location: null, error: null })),
