// FILE PATH: app/restaurant/[id]/[slug]/page.tsx
'use client';
  ...
  const loadRecommendations = async () => {
    ...
    try {
      ...
      const mockRecommendations: Recommendation[] = [
        {
          id: '1',
          title: 'Experiência incrível no almoço!',
          content: 'O melhor da culinária nordestina em Brasília! O cordeiro assado estava perfeito, com temperos autênticos que me lembraram da minha infância no Nordeste. O ambiente é acolhedor e o atendimento excepcional. Recomendo muito para quem quer uma experiência gastronômica autêntica.',
          author: {
            name: 'Maria Silva',
            avatar: '👩‍🦱',
            verified: true,
        ...
        {
          id: '2',
          title: 'Ótimo para ocasiões especiais',
          content: 'Fomos lá para comemorar nosso aniversário de casamento e foi perfeito! O baião de dois estava delicioso e a carne de sol muito bem preparada. O ambiente tem uma decoração linda que remete ao Nordeste. Voltaremos com certeza!',
          author: {
            name: 'João Santos',
            avatar: '👨‍💼',
            verified: false,
          ...
          likes: 8,
          tags: ['Romântico', 'Especial', 'Aniversário'],
          personalRating: 8
        },
        {
          id: '3',
          title: 'Excelente para almoço de negócios',
          content: 'Lugar ideal para reuniões de trabalho. O ambiente é tranquilo, o atendimento é rápido e eficiente, e a comida é sempre consistente. O prato executivo tem ótimo custo-benefício.',
          author: {
            name: 'Ana Costa',
            avatar: '👩‍💻',
            verified: true,
          ...
          likes: 6,
          tags: ['Trabalho', 'Executivo', 'Rápido']
        }
      ];
      ...
      <div className="max-w-4xl mx-auto px-4 py-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
          <div className="flex bg-gray-100 rounded-lg p-1">
            ...
            >
              👤 Amigos ({recommendations.filter(r => r.socialDistance === 1).length})
            </button>
            <button
          ...
          >
            ...
            <option value="social">Proximidade Social</option>
          </select>
        </div>
            ...
            <div key={recommendation.id} className="bg-white rounded-lg border border-gray-200 p-6">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2 text-sm text-gray-600">
                      <span>Trust Score: {recommendation.author.trustScore}</span>
                      <span>•</span>
                ...
                <div className="flex items-center gap-2">
                  ...
                  {recommendation.personalRating && (
                    <div className="flex items-center text-sm text-gray-600">
                      ...
                      {recommendation.personalRating}/10
                    </div>
                  )}
                </div>
              </div>
              ...
              <div className="flex items-center justify-between text-sm text-gray-500">
                ...
                {recommendation.photos && recommendation.photos.length > 0 && (
                  <div className="flex items-center gap-1">
                    <span>📷 {recommendation.photos.length} fotos</span>
                  </div>
                )}
              </div>
            </div>
        ...
        {filteredRecommendations.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600">
              Seja o primeiro a recomendar este restaurante!
            </p>
          </div>
        )}
      </div>
