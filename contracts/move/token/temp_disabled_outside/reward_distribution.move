...
module omeone_token::reward_distribution {
    ...
    public struct RewardTracker has key {
        id: UID,
    ...
    public struct PendingReward has store {
        author: address,
        action_id: vector<u8>,
        action_type: u8,
        base_amount: u64,
    ...
    public struct SocialWeight has store {
    ...
    public struct SocialEndorsement has store {
        endorser: address,
    ...
    public struct RewardCalculation has copy, drop {
        base_reward: u64,
    ...
    public struct TrustThresholdReached has copy, drop {
        action_id: vector<u8>,
        final_trust_score: u64,
        reward_amount: u64,
    }

    public struct SocialEndorsementAdded has copy, drop {
        action_id: vector<u8>,
        endorser: address,
        weight_contribution: u64,
    }
